  ...
  return (
    <Center h="100vh" bg="brand.50">
      <Box p={8} bg="white" rounded="xl" shadow="xl" maxW="md" w="full" textAlign="center">
        ...
        <Heading color="brand.600" mb={2}>{theme?.nombre || 'LoginSplitScreen'}</Heading>
        <Text color="gray.500" mb={6}>Bienvenido a la plantilla LoginSplitScreen</Text>
